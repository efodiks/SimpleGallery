...
import kotlinx.android.synthetic.main.fragment_images_recycler_view.*
import kotlinx.android.synthetic.main.fragment_images_recycler_view.view.*
...
class ImagesRecyclerFragment : Fragment() {
    private val viewModel by sharedViewModel<ImagesUrisViewModel>()
    private val TAG = "ImagesRecyclerFragment"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.fragment_images_recycler_view, container, false)

        view.imagesRecyclerView.layoutManager = GridLayoutManager(context, 2)

        val adapter = ImagesRecyclerAdapter { position, v ->
